...
class Artist extends DatabaseMappedModel {
  ...
  @override
  Map<String, dynamic> toDbMap() =>
      {'mbid': mbid, 'url': url, 'imageInfo': imageInfo?.toMap()};
}
...
class TrackScrobble extends DatabaseMappedModel {
  ...
  const TrackScrobble({this.trackId, this.artistId, this.date});
...
class ArtistSelection extends DatabaseMappedModel {
  ...
  @override
  Map<String, dynamic> toDbMap() =>
      {'artistId': artistId, 'selectionColor': selectionColor.value};
}
