...
import 'dart:async';
import 'package:lastfm_dashboard_infrastructure/services/local_database/database_service.dart';
...
class WebDatabaseBuilder {
  WebDatabaseBuilder(WebDatabaseInfo info):
    path = info.databaseFileName,
    usersStorePath = info.usersPath,
    artistsStorePath = info.artistsPath,
    tracksStorePath = info.tracksPath,
    trackScrobblesStorePath = info.trackScrobblesPath,
    artistSelectionsStorePath = info.artistSelectionsStorePath,
